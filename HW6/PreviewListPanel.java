...
/**
 * PreviewListPanel Panel which takes in a set of Previewable files and displays
 * them in a JScrollPane. Can notify listeners of when a Previewable file is
 * selected. Only allows single selection. Changelog: -1.0.1 Added more detailed
 * Javadocs for students.
 * @author David Leber
...
public class PreviewListPanel extends JPanel {
    ...
    /**
     * addActionListener(ActionListener listener) Allows an ActionListener to
     * listen for highlight events. Notifies listeners when the user changes the
     * highlighted item.
    ...
    private class PreviewListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            Previewable clicked = ((JList<Previewable>) e.getSource())
                    .getSelectedValue();
